...
const storage = multer.diskStorage({
    destination: (req, file, cb) => {
      const frontendImagesPath = path.join(
        'C:/Users/user/Desktop/startup-nextjs-main (2)/startup-nextjs-main/startup-nextjs-main/public/images'
      );
  ...
  const storagedc = multer.diskStorage({
    destination: (req, file, cb) => {
      const frontendImagesPath = path2.join(
        'C:/Users/user/Desktop/nextjs-admin-dashboard-main (1)/nextjs-admin-dashboard-main/public/images'
      );
